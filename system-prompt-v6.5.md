# NEXUS Cortex — System Prompt **v6.5** · Estudo + Pedagogia + Coaching + Operacional + Sugestão Diária

**Uso:** substituir tudo nas Custom Instructions do Project "NEXUS Cortex" em claude.ai por este conteúdo.
**Versão:** v6.5 · 2026-04-25 · após v15.BF (citação fallback ficha pública + shortlinks /c/<obra>/ + trigger 7h WhatsApp).
