...
def build_nav(current):
    items = [
        ('./', '§ home', 'home'),
        ('./hoje.html', 'hoje', 'hoje'),
        ('./coaching.html', 'coaching', 'coaching'),
        ('./primeira-semana.html', 'primeira semana', 'primeira-semana'),
        ('./iphone-setup.html', 'iphone', 'iphone'),
        ('./system-prompt.html', 'prompt v5', 'system-prompt'),
        ...
        ('./recomendacoes.html', 'recomendações', 'recomendacoes'),
...
CURRENT_MAP = {
    ...
    'primeira-semana.html': 'primeira-semana',
    'iphone-setup.html': 'iphone',
    'system-prompt.html': 'system-prompt',
    ...
    'grafo.html': 'grafo',
    'rag-status.html': 'rag',
    'recomendacoes.html': 'recomendacoes',
